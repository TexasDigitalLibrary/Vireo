...
public interface ExportPackage {
    ...
    /**
     * @return A File pointer to the package. The file may be either a directory on disk or a single
     *         file depending upon the packager and the specific format it includes.
     */
    public File getFile();
    ...
    /**
     * Release all resources used by this package. All callers who generate a package must call the
     * delete() method when finished.
     */
    public void delete();
