...
public class SubmissionFieldProfileRepoImpl implements SubmissionFieldProfileRepoCustom {
    ...
    public SubmissionFieldProfile create(FieldProfile fieldProfile) {
        ...
        SubmissionFieldProfile submissionfieldProfile = submissionFieldProfileRepo.findByFieldPredicateAndInputTypeAndRepeatableAndOptionalAndHiddenAndFlaggedAndLoggedAndUsageAndHelpAndMappedShibAttribute(fieldProfile.getFieldPredicate(), fieldProfile.getInputType(), fieldProfile.getRepeatable(), fieldProfile.getOptional(), fieldProfile.getHidden(),fieldProfile.getFlagged(), fieldProfile.getLogged(), fieldProfile.getUsage(), fieldProfile.getHelp(), fieldProfile.getMappedShibAttribute());
