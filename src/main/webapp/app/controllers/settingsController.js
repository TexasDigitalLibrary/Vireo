vireo.controller("SettingsController", function ($controller, $injector, $scope, $timeout, UserService, UserSettings, ManagedConfigurationRepo, StudentSubmissionRepo, SubmissionStates) {
    ...
    var updateScope = function () {
        ...
        if ($scope.isAdmin()) {
            ...
            DegreeRepo.getProquestDegreeCodes().then(function (data) {
    ...
    UserService.userEvents().then(null, null, function (event) {
        if (event === 'RECEIVED') {
            updateScope();
        }
    });
