...
public class WorkflowStepTest {
    ...
    public void testCascade() {
        ...
        assertEquals("Saved entity did not contain the field profile required value!", TEST_FIELD_PROFILE_REQUIRED, workflowStep.getFieldProfileByPredicate(fieldPredicate).getRequired());
        assertEquals("Saved entity did not contain the field profile input type!", TEST_FIELD_PROFILE_INPUT_TYPE, workflowStep.getFieldProfileByPredicate(fieldPredicate).getInputType());
        assertEquals("Saved entity did not contain the field profile repeatable value!", TEST_DETACHABLE_FIELD_PROFILE_REPEATABLE, workflowStep.getFieldProfileByPredicate(detachableFieldPredicate).getRepeatable());
        assertEquals("Saved entity did not contain the field profile required value!", TEST_DETACHABLE_FIELD_PROFILE_REQUIRED, workflowStep.getFieldProfileByPredicate(detachableFieldPredicate).getRequired());
        assertEquals("Saved entity did not contain the field profile input type!", TEST_DETACHABLE_FIELD_PROFILE_INPUT_TYPE, workflowStep.getFieldProfileByPredicate(detachableFieldPredicate).getInputType());
