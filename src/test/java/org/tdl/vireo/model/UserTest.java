...
public class UserTest extends AbstractEntityTest {
	...
	public void testCreate() {
		...
		assertEquals("Saved user did not contain the correct first name!", TEST_USER_FIRSTNAME,
	...
	public void testCascade() {
		Address currentAddress = addressRepo.create(TEST_CURRENT_ADDRESS1, TEST_CURRENT_ADDRESS2, TEST_CURRENT_CITY,
				TEST_CURRENT_STATE, TEST_CURRENT_POSTAL_CODE, TEST_CURRENT_COUNTRY);
		...
		Address permanentAddress = addressRepo.create(TEST_PERMANENT_ADDRESS1, TEST_PERMANENT_ADDRESS2,
				TEST_PERMANENT_CITY, TEST_PERMANENT_STATE, TEST_PERMANENT_POSTAL_CODE, TEST_PERMANENT_COUNTRY);
		assertEquals("The address does not exist!", 2, addressRepo.count());
		ContactInfo permanentContactInfo = contactInfoRepo.create(permanentAddress, TEST_PERMANENT_PHONE,
				TEST_PERMANENT_EMAIL);
