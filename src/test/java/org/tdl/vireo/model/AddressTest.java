...
public class AddressTest extends AbstractEntityTest {
	...
	public void testCreate() {
		Address testAddress = addressRepo.create(TEST_ADDRESS1, TEST_ADDRESS2, TEST_CITY, TEST_STATE, TEST_POSTAL_CODE,
				TEST_COUNTRY);
		...
		assertEquals("Created address does not contain the correct address2 ", TEST_ADDRESS2,
		...
		assertEquals("Created address does not contain the correct postalCode ", TEST_POSTAL_CODE,
