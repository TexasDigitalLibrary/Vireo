...
public class FieldProfileTest extends AbstractEntityTest {
    ...
    public void testInheritAndRemoveFieldProfiles() {
        ...
        // this test calls for adding a single workflowstep to the parent
        // organization
    ...
    public void testFieldProfileChangeAtChildOrg() throws HeritableModelNonOverrideableException, WorkflowStepNonOverrideableException, ComponentNotPresentOnOrgException {
        ...
        // pointer to fieldProfile became updatedFieldProfile, must fetch it
        // agains
        fieldProfile = fieldProfileRepo.findOne(originalFieldProfileId);

        // There should be a new workflow step on the child organization that is
        // distinct from the original workflowStep
        ...
        // The updatedFieldProfile should be distinct from the original
        // fieldProfile
        ...
        // the grandchild and great grandchildren should all be using the new
        // workflow step and the updatedFieldProfile
    ...
    public void testMaintainFieldOrderWhenOverriding() throws HeritableModelNonOverrideableException, WorkflowStepNonOverrideableException, ComponentNotPresentOnOrgException {
        ...
        // now, override the second step at the grandchild and ensure that the
        // new step is the second step at the grandchild and at the great
        // grandchildren
        fp2.setHelp("help!");
        grandChildOrganization = organizationRepo.findOne(grandChildOrganization.getId());
    ...
    // TODO: this test is not done, development of the full feature deferred for
    // now
    @Test
    public void testMakeFieldProfileNonOverrideable() throws HeritableModelNonOverrideableException, WorkflowStepNonOverrideableException, ComponentNotPresentOnOrgException {
        ...
        // ensure that a new note got made at the grandchild after this override
        // (to non-overrideable :) )
        ...
        // ensure that a new note got made at the child after this override (to
        // non-overrideable :) )
        // old n2 should still be overrideable
        ...
        // ensure that the grandchild's new note is replaced by the child's
        // non-overrideable one
        ...
        // TOOO: ensure that the child's note is replaced by the original,
        // non-overrideable at both the child and grandchild

        // now all is restored, except one of the notes is non-overrideable at
        // the parent

        // TODO: remove a note at the grandchild
        // TODO: make the removed note non-overrideable at the parent
        // TODO: ensure that the removed note is reaggregated upon the
        // grandchild who removed it
    ...
    public void testDeleteFPAtDescendantOrgAndDuplicateWSIsDeletedToo() throws HeritableModelNonOverrideableException, WorkflowStepNonOverrideableException, ComponentNotPresentOnOrgException {
        ...
        // TODO: make fieldProfile non-overrideable, check that fpPrime goes
        // away and the new derivative step goes away
