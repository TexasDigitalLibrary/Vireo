...
public class ControlledVocabularyTest {
    ...
    private static final String TEST_CONTROLLED_VOCABULARY_NAME = "Test Vocabulary";

    private static final String TEST_CONTROLLED_VOCABULARY_VALUE            = "Test Vocabulary Value";
    private static final String TEST_DETACHABLE_CONTROLLED_VOCABULARY_VALUE = "Test Detachable Vocabulary Value";
