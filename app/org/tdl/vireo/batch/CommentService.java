...
/**
 * Batch comment to service. This service handles the background tasks of
 * adding a comment and the option of sending an email on a set of submissions.
 * 
 * @author Micah Cooper
 * 
 */
public interface CommentService {
	 ...
	 */
	public JobMetadata comment(SearchFilter filter, String comment, String subject, Boolean visibility, Boolean sendEmail, Boolean ccAdvisor);
