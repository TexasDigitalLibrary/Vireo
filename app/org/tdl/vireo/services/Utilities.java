...
public class Utilities {
  ...
  private static final List<Namespace> ns = new ArrayList<Namespace>(
    Arrays.asList(
      Namespace.getNamespace("internal", "http://www.orcid.org/ns/internal"),
      Namespace.getNamespace("funding", "http://www.orcid.org/ns/funding"),
      Namespace.getNamespace("preferences", "http://www.orcid.org/ns/preferences"),
      Namespace.getNamespace("address", "http://www.orcid.org/ns/address"),
      Namespace.getNamespace("education", "http://www.orcid.org/ns/education"),
      Namespace.getNamespace("work", "http://www.orcid.org/ns/work"),
      Namespace.getNamespace("deprecated", "http://www.orcid.org/ns/deprecated"),
      Namespace.getNamespace("other-name", "http://www.orcid.org/ns/other-name"),
      Namespace.getNamespace("history", "http://www.orcid.org/ns/history"),
      Namespace.getNamespace("employment", "http://www.orcid.org/ns/employment"),
      Namespace.getNamespace("error", "http://www.orcid.org/ns/error"),
      ...
      Namespace.getNamespace("peer-review", "http://www.orcid.org/ns/peer-review"),
      Namespace.getNamespace("personal-details", "http://www.orcid.org/ns/personal-details"), // index 17, used below
      Namespace.getNamespace("bulk", "http://www.orcid.org/ns/bulk"),
	...
	public static boolean verifyOrcid(String orcid, String firstName, String lastName) {
		...
		try {
			...
			if (singleXPath(doc, "/record:record", ns) == null) {
				Logger.warn("Failed to get an ORCID message");
				return false;
			}
			// Check for the error (orcid not found) message
			if (singleXPath(doc, "//error", ns) != null)
			{
				Logger.info("Invalid ORCID specified");
				return false;
			}
			// Validate the name
			Element personalDetails = singleXPath(doc, "//person:person/person:name", ns);
			...
			if (personalDetails != null) {
				...
				/* <persona:name>
	             <personal-details:given-names>Alexey</personal-details:given-names>
	             <personal-details:family-name>Maslov</personal-details:family-name>
	         </person:name> */
				else {
          // index 17 is personal-details ns
					Element orcidFirstName = personalDetails.getChild("given-names", ns.get(17));
					Element orcidLastName = personalDetails.getChild("family-name", ns.get(17));
