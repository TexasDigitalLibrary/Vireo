...
rm -rf /tmp/play/
rm -f /tmp/play.zip
curl –silent http://download.playframework.org/releases/play-1.2.5-RC3.zip -o /tmp/play.zip
...
rm -rf ./vireo/
rm -f ./vireo.zip
curl –silent -L -k -u TDLVireo:Vireo20 https://github.com/TexasDigitalLibrary/Vireo/zipball/master -o ./vireo.zip
